...
![git status](screenshots/wk4-a3-s1.png)
...
![git checkout new brach](screenshots/wk4-a3-s2.png)
...
![ls](screenshots/wk4-a3-s3.png)

---

#### Screenshot 4 — Output of `git commit`

![git commit](screenshots/wk4-a3-s4.png)

---

#### Screenshot 5 — Output of `git log --oneline -3` showing the new commit

![git log](screenshots/wk4-a3-s5.png)
...
![git status](screenshots/wk4-a3-s6.png)

---

#### Screenshot 7 — Output of `git commit`

![git commit](screenshots/wk4-a3-s7.png)

---

#### Screenshot 8 — Browser showing the Contact Page link on the homepage while on `feature/contact-page`

![contact page](screenshots/wk4-a3-s8.png)
...
![full git log](screenshots/wk4-a3-s14.png)
...
![delete feature branch](screenshots/wk4-a3-s15.png)
