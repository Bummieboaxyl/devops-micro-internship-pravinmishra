...
![Generic response](<screenshots/Claude generic response.png>)
...
![Auto generated claude](<screenshots/Auto generated claude.md.png>)
...
![Custom1](<screenshots/Custom claude01.png>)
![Custom2](<screenshots/Custom claude02.png>)
![Custom3](<screenshots/Custom claude03.png>)
![Custom4](<screenshots/Custom claude04.png>)
...
![Detailed response1](<screenshots/Updated claude response01.png>)
![Detailed response2](<screenshots/Updated claude response02.png>)
---

#### Screenshot 5 — Claude refusing or warning against adding React because of the "No JavaScript" convention defined in CLAUDE.md

![No Javascript](<screenshots/No Javascript pushback.png>)
...
![Claude.md on Github Repo](<screenshots/Claude.md on GitHub Repo.png>)
